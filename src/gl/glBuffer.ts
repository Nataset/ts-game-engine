namespace TSE {
    /**
     * Repersents the information needed for a GLBuffer attribute.
     */
    export class AttributeInfo {
        ...
        /**
         * The number of eleents from the beginning of the buffer.
         */
    ...
    export class GLBuffer {
            ...
            if (this._hasAttributeLocation) {
                for (let it of this._attributes) {
                    gl.vertexAttribPointer(
                        it.location as number,
                        it.size as number,
                        this._dataType,
                        normalized,
                        this._stride,
                        (it.offset as number) * this._typeSize,
                    );
                    gl.enableVertexAttribArray(it.location as number);
                }
            }
        }
        ...
        public unbind(): void {
            for (let it of this._attributes) {
                gl.disableVertexAttribArray(it.location as number);
            }
        ...
        public upload(): void {
            ...
            switch (this._dataType) {
                ...
                default:
                    bufferData = null;
                    throw new Error('unknow data type pass in buffer');
            }
